...
Currently, heic-to is using [libheif 1.22.1](https://github.com/strukturag/libheif/releases/tag/v1.22.1) under the hood. 
...
```html
<script src="https://cdn.jsdelivr.net/npm/heic-to@1.5.1/dist/iife/heic-to.js"></script>
<script>
  /*...*/
