...
Currently, heic-to is using [libheif 1.21.1](https://github.com/strukturag/libheif/releases/tag/v1.21.1) under the hood. 
...
```html
<script src="https://cdn.jsdelivr.net/npm/heic-to@1.4.1/dist/iife/heic-to.js"></script>
<script>
  /*...*/
